...
# 读取 Excel 文件
routes_df = pd.read_excel(r"D:\Pycharm\py\code\速度成本\speed1-cost1\Figures\experiment606250001\percentage[0, 1]parallel_number3\routes_matchpercentage[0, 1]parallel_number3606250001.xlsx", header=None)
intermodal_df = pd.read_excel(r"D:\Pycharm\py\code\速度成本\speed1-cost1\Figures\experiment606250001\Intermodal_EGS_data_all.xlsx", sheet_name='R_10', header=None)
exp_df = pd.read_excel(r"D:\Pycharm\py\code\速度成本\speed1-cost1\results\exps_record_all_parallelexp606250001parallel3.xlsx", sheet_name='exps_record')
obj_df = pd.read_excel(r"D:\Pycharm\py\code\速度成本\speed1-cost1\Figures\experiment606250001\percentage[0, 1]parallel_number3\obj_recordpercentage[0, 1]parallel_number3606250001.xlsx", sheet_name='obj_record_best')
...
#单位碳税（per_ton_km)
carbon_tax_per_ton = (exp_df['best_emission_cost']*1000 / obj_df['cost_per_distance'].iloc[-1]) / qr_sum
...
# 定义保存路径
output_folder = r"D:\Pycharm\py\code\速度成本\speed1-cost1\单位成本和载具空间利用率"
output_file = os.path.join(output_folder, "结果1.xlsx")
...
print("结果已保存到 Excel 文件中：", output_file)